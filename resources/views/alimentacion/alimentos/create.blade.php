...
@section('title', 'Registrar Nuevo Alimento')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-plus-circle text-warning"></i> Registrar Nuevo Alimento
        </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('alimentacion.alimentos.store') }}" id="alimentoForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="tipo" name="tipo" required>
                            ...
                            <option value="forraje" {{ old('tipo') == 'forraje' ? 'selected' : '' }}>Forraje</option>
                            <option value="suplemento" {{ old('tipo') == 'suplemento' ? 'selected' : '' }}>Suplemento</option>
                            <option value="mineral" {{ old('tipo') == 'mineral' ? 'selected' : '' }}>Mineral</option>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              rows="3" 
                              placeholder="Descripción del alimento, composición, instrucciones de uso, etc.">{{ old('descripcion') }}</textarea>
                </div>
        ...
        function actualizarResumen() {
            ...
            if (nombre.value && tipo.value && unidadMedida.value) {
                resumenText.innerHTML = `
                    ...
                    Stock inicial: <strong>${stockVal} ${unidadVal}</strong> | Precio: ${precioVal}
                `;
