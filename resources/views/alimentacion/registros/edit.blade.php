...
@section('title', 'Editar Registro de Alimentación')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit text-primary"></i> Editar Registro de Alimentación
        </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('alimentacion.registros.update', $registro['id']) }}" id="registroForm">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="finca_id" name="finca_id" required>
                            ...
                            <option value="{{ $finca['id'] }}" {{ old('finca_id', $registro['finca_id']) == $finca['id'] ? 'selected' : '' }}>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="animal_id" name="animal_id">
                            ...
                            <option value="{{ $animal['id'] }}" {{ old('animal_id', $registro['animal_id']) == $animal['id'] ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="turno" name="turno" required>
                            ...
                            <option value="mañana" {{ old('turno', $registro['turno']) == 'mañana' ? 'selected' : '' }}>Mañana</option>
                            <option value="tarde" {{ old('turno', $registro['turno']) == 'tarde' ? 'selected' : '' }}>Tarde</option>
                            <option value="noche" {{ old('turno', $registro['turno']) == 'noche' ? 'selected' : '' }}>Noche</option>
                        </select>
                    </div>
                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="dieta_id" name="dieta_id" required>
                            ...
                            @if($dieta['activa'] || $dieta['id'] == $registro['dieta_id'])
                            <option value="{{ $dieta['id'] }}" 
                                    data-costo="{{ $dieta['costo_estimado_kg'] ?? 0 }}"
                                    {{ old('dieta_id', $registro['dieta_id']) == $dieta['id'] ? 'selected' : '' }}>
                        ...
                        <small class="form-text text-muted">Puede seleccionar dietas inactivas si ya estaban asignadas</small>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" min="0.1" class="form-control" 
                               ...
                               value="{{ old('cantidad_total', $registro['cantidad_total']) }}" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" 
                               ...
                               value="{{ old('responsable', $registro['responsable']) }}" 
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="number" step="0.01" min="0" class="form-control" 
                               ...
                               value="{{ old('costo_total', $registro['costo_total']) }}" 
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              rows="3" 
                              placeholder="Observaciones sobre la alimentación, comportamiento del animal, etc.">{{ old('observaciones', $registro['observaciones']) }}</textarea>
                </div>

                <!-- Información de la Dieta Seleccionada -->
                <div class="alert alert-info" id="dietaInfo">
                ...
                <div class="alert alert-success" id="resumenRegistro">
                ...
                <div class="alert alert-secondary">
                    ...
                    Creado el {{ \Carbon\Carbon::parse($registro['created_at'])->format('d/m/Y H:i') }} | 
                    Última actualización: {{ \Carbon\Carbon::parse($registro['updated_at'])->format('d/m/Y H:i') }}
                </div>
