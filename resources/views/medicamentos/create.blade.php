...
@section('title', 'Registrar Nuevo Medicamento')
...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-plus-circle text-info"></i> Registrar Nuevo Medicamento
        </h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-info">
                <i class="fas fa-info-circle me-2"></i>Información del Medicamento
            </h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('medicamentos.store') }}" id="medicamentoForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="tipo" name="tipo" required>
                            ...
                            <option value="vacuna" {{ old('tipo') == 'vacuna' ? 'selected' : '' }}>Vacuna</option>
                            <option value="antibiotico" {{ old('tipo') == 'antibiotico' ? 'selected' : '' }}>Antibiótico</option>
                            <option value="vitaminas" {{ old('tipo') == 'vitaminas' ? 'selected' : '' }}>Vitaminas</option>
                            <option value="desparasitante" {{ old('tipo') == 'desparasitante' ? 'selected' : '' }}>Desparasitante</option>
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <textarea class="form-control" 
                                  ...
                                  rows="3" 
                                  placeholder="Descripción del medicamento, composición, etc.">{{ old('descripcion') }}</textarea>
                    </div>
                </div>
