...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-edit text-warning"></i> Editar Producción de Leche
        </h1>
    ...
    <div class="card shadow mb-4">
        <div class="card-header py-3">
            <h6 class="m-0 font-weight-bold text-warning">
                <i class="fas fa-pencil-alt me-2"></i>Editar Información de la Producción
            </h6>
        </div>
        <div class="card-body">
            <form method="POST" action="{{ route('produccion-leche.update', $produccion['id']) }}" id="produccionForm">
                @csrf
                @method('PUT')
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="animal_id" name="animal_id" required>
                            ...
                            <option value="{{ $animal['id'] }}" 
                                {{ (old('animal_id', $produccion['animal_id']) == $animal['id']) ? 'selected' : '' }}>
                                {{ $animal['identificacion'] }} - {{ $animal['nombre'] ?: 'Sin nombre' }} 
                                ({{ $animal['especie'] }} - {{ $animal['finca']['nombre'] ?? 'N/A' }})
                            </option>
                            @endforeach
                        </select>
                        <small class="form-text text-muted">Solo se muestran hembras</small>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="date" class="form-control" 
                               id="fecha" name="fecha" 
                               value="{{ old('fecha', $produccion['fecha']) }}" 
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" 
                               ...
                               value="{{ old('cantidad_leche', $produccion['cantidad_leche']) }}" 
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" 
                               ...
                               value="{{ old('calidad_grasa', $produccion['calidad_grasa']) }}" 
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="number" step="0.01" class="form-control" 
                               ...
                               value="{{ old('calidad_proteina', $produccion['calidad_proteina']) }}" 
                               min="0" max="100" placeholder="0.00">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="turno" name="turno" required>
                            ...
                            <option value="mañana" {{ (old('turno', $produccion['turno']) == 'mañana') ? 'selected' : '' }}>Mañana</option>
                            <option value="tarde" {{ (old('turno', $produccion['turno']) == 'tarde') ? 'selected' : '' }}>Tarde</option>
                            <option value="noche" {{ (old('turno', $produccion['turno']) == 'noche') ? 'selected' : '' }}>Noche</option>
                        </select>
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              rows="3" 
                              placeholder="Observaciones sobre la producción, condiciones del animal, etc.">{{ old('observaciones', $produccion['observaciones']) }}</textarea>
                </div>
