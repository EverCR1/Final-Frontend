...
<div class="container-fluid">
    ...
    <div class="d-sm-flex align-items-center justify-content-between mb-4">
        <h1 class="h3 mb-0 text-gray-800">
            <i class="fas fa-plus-circle text-primary"></i> Registrar Nueva Vacunación
        </h1>
    ...
    <div class="card shadow mb-4">
        ...
        <div class="card-body">
            <form method="POST" action="{{ route('vacunaciones.store') }}" id="vacunacionForm">
                @csrf
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <small class="form-text text-muted">Seleccione el animal a vacunar</small>
                    </div>
                ...
                <div class="row">
                    ...
                    <div class="col-md-4 mb-3">
                        ...
                        <input type="date" class="form-control" 
                               ...
                               value="{{ old('fecha_vacunacion', date('Y-m-d')) }}" 
                               max="{{ date('Y-m-d') }}" required>
                        <small class="form-text text-muted">Fecha cuando se aplica la vacuna</small>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <select class="form-select" id="veterinario" name="veterinario" required>
                            ...
                            <option value="{{ $vet['name'] }}" 
                                {{ old('veterinario', session('user.role') === 'veterinario' ? session('user.name') : '') == $vet['name'] ? 'selected' : '' }}>
                                {{ $vet['name'] }} 
                                @if($vet['email'])
                                - {{ $vet['email'] }}
                                @endif
                ...
                <div class="mb-3">
                    ...
                    <textarea class="form-control" 
                              ...
                              rows="3" 
                              placeholder="Observaciones adicionales sobre la vacunación...">{{ old('observaciones') }}</textarea>
                </div>
                ...
                <div class="d-flex justify-content-between">
                    ...
                    <button type="submit" class="btn btn-primary">
                        <i class="fas fa-save me-2"></i>Guardar Vacunación
                    </button>
                </div>
            </form>
        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        ...
        function validarStockYDosis() {
            ...
            if (selectedOption && stockDisponible > 0) {
                ...
                if (stockDisponible <= 10) { // Puedes ajustar este valor
